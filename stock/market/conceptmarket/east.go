...
func GetConceptDailyEast(indexCode string, kType int) ([]ConceptDailyBar, error) {
	if indexCode == "" {
...
func GetConceptMinuteEast(indexCode string) ([]ConceptMinuteBar, error) {
	if indexCode == "" {
...
func GetConceptCurrentEast(indexCode string) (ConceptCurrent, error) {
	if indexCode == "" {
	...
	if preClose != 0 {
		cur.ChangePct = cur.Change / preClose * 100
	}
